...
<p align="center">
  <img src="./Img/Scrape.png" alt="Statoscope example" width="800">
</p>
...
<p align="center">
  <img src="./Img/Name.png" alt="Statoscope example" width="800">
</p>
...
### Selector Gadget Method

<p align="center">
  <img src="./Img/Star.png" alt="Statoscope example" width="800">
</p>
...
<p align="center">
  <img src="./Img/gadget.png" alt="Statoscope example" width="800">
</p>
...
<p align="center">
  <img src="./Img/X.png" alt="Statoscope example" width="800">
</p>

Were just going to be using the first page of results to make it simpler, but you can run it as a loop as the html nodes version and it will work just fine.


### Rating
The star rating results show up as a number "out of 5 stars" and it would be better if we just got the actual number rating value.
